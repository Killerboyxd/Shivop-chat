...
DEV_OP = [
    ...
    [
        InlineKeyboardButton(text="❄️ sᴏᴜʀᴄᴇ ❄️", callback_data="ll_SABKA_BHAI_KILLER_ll"),
        InlineKeyboardButton(text="☁️ ᴀʙᴏᴜᴛ ☁️", callback_data="ll_SABKA_BHAI_KILLER_ll"),
    ],
]
PNG_BTN = [
    [
...
**➻ ᴜsᴇ `/shiv` ғᴏʀ ɢᴇᴛᴛɪɴɢ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ!**
**──────────────**
